...
?>
    ...
    <div class="col-sm-6">
      <center><h1><b><?php echo $rows['LodgeName'] ?></b></h1></center>
      <div class="row">
        <div class="col-sm-6">
          <div class="row">
            <div class="col-sm-6">
              <table>
                ...
                <tr>
                  <td><h3><b>Lodge Name:</b></h3></td>
                  <td><h4><?php echo $rows['LodgeName']; ?></h4></td>
                </tr>

                <tr>
                  <td><h3><b>Room Type:</b></h3></td>
                  <td><h4><?php echo $rows['RoomType']; ?></h4></td>
                </tr>
                <tr>
                  <td><h3><b>Price:</b></h3></td>
                  <td><h4><?php echo $rows['RoomPrice']; ?></h4></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><h4><?php echo $rows['PhoneNumber']; ?></h4></td>
                </tr>
                <tr>
                  <td><h3><b>Nearby places:</b></h3></td>
                  <td><h4><?php echo $rows['nearbyplaces']; ?></h4></td>
                </tr>
                <tr>
                  <td><h3><b>Estimated time to campus:</b></h3></td>
                  <td><h4><?php echo $rows['time']; ?></h4></td>
                </tr>
                <tr>
        ...
        <div class="col-sm-6">
          <table>
            <tr>
              <td><h3><b>Facilities:</b></h3></td>
              <td><h4><?php echo $rows['facilities']; ?></h4></td>
            </tr>
            <tr>
              <td><h3><b>Free service:</b></h3></td>
              <td><h4><?php echo $rows['service']; ?></h4></td>
            </tr>
            <tr>
              <td><h3><b>Security system:</b></h3></td>
              <td><h4><?php echo $rows['securitysystem']; ?></h4></td>
            </tr>
            <tr>
              <td><h3><b>Location:</b></h3></td>
              <td><h4><?php echo $rows['Location']; ?></h4></td>
            </tr>
            <tr>
              <td><h3><b>Allowed pet:</b></h3></td>
              <td><h4><?php echo $rows['Pet']; ?></h4></td>
            </tr>
            <tr>
              <td><h3><b>Cost of utilities:</b></h3></td>
              <td><h4><?php echo $rows['costofutilities']; ?></h4></td>
            </tr>
            <tr>
